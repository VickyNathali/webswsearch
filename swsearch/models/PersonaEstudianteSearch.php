 ...
 */
class PersonaEstudianteSearch extends Persona {
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', 'CEDULA_PER', $this->CEDULA_PER])
                ...
                ->andFilterWhere(['like', 'TOKEN_PER',$this->TOKEN_PER])                
                //->andFilterWhere(['like', 'CONTRASENA_PER', $this->CONTRASENA_PER])
                //->andFilterWhere(['like', 'FOTO_PER', $this->FOTO_PER])
                ->innerJoin('estudiante', 'persona.CEDULA_PER = estudiante.CEDULA_PER')
                ->andFilterWhere(['!=', 'TOKEN_PER', $id]); //solo me muestra estudiantes acivos e inactivo
