...
class HoraController extends Controller {
    ...
    public function actionListar() {
        ...
        $modelo_hora = Hora::find()->orderBy('INICIO_HORA asc')->all();
    ...
    public function actionCreate() {
        $model = new Hora();
        $model->ESTADO_HORA = 1; //afuera de post xq si se presenta la opcion de escoger en la vista _form CASO CONTRARIO: poner dentro de post       
    ...
    //eliminado lógico de HORA
    public function actionDelete_hora($id) {
        $estado = Hora::findOne(['ID_HORA' => $id]);
        $estado->ESTADO_HORA = 3; //eliminada
        $estado->save();
        return $this->redirect(['index']);
    }
    /**
