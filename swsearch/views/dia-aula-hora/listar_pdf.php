...
<html lang="es">
    ...
    <body>
        ...
        mpdf-->       
        <?php
        $this->title = 'LISTA DE HORARIOS DE CLASE';
        ?>
        ...
        <div class="row">    
            ...
            $aux_paralelo = 'vacio';
            $bandera_salto = 0;
            foreach ($listar_horarios as $hi) {
                if ($hi['ID_SEM'] != $aux_semestre || $hi['PARALELO'] != $aux_paralelo) {
                    $aux_paralelo = $hi['PARALELO'];
                    $aux_semestre = $hi['ID_SEM'];
                    ?>
                    <?php if ($bandera_salto > 0) { ?>    
                        <div class="" style="page-break-before: always;"> <!--para salto de pagina-->
                            <?php
                        } else {
                            $bandera_salto = 1;
                            ?>
                                ...
                                <table width="100%" >
                                    <tr>
                                        <td width="50%" style="text-align:left;">
                                            <?= Html::img(Yii::$app->homeUrl . '/imagenes/logo-espoch.png', ['width' => '7%']) ?>
                                            <?php
                                            echo "<br>" . "<b>ESCUELA: </b>" . "INFORMÁTICA Y ELECTRÓNICA";
                                            echo "<br>";
                                            echo "<br>";
                                            echo "<br>";
                                            echo "<br>";
                                        ...
                                        <td width="50%" style="text-align:right;" >
                                            <?= Html::img(Yii::$app->homeUrl . '/imagenes/logo-eis.jpg', ['width' => '7%']) ?>
                                            <?php
