        ...
        <div class="col-md-6"> 
            <div class="panel panel-footer" id="cuadroDI" >
                ...
                <div class="panel-body">
                    ...
                    <?= $form->field($model, 'NOMBRES_PER')->textInput(['maxlength' => true, 'placeholder' => 'Ej.: JUAN ALBERTO', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'onkeypress' => 'return soloLetras(event);', 'onpaste' => 'return false']) ?>
                    <?= $form->field($model, 'APELLIDOS_PER')->textInput(['maxlength' => true, 'placeholder' => 'Ej.: ALTAMIRANO LÓPEZ', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'onkeypress' => 'return soloLetras(event);', 'onpaste' => 'return false']) ?>
                    <?= $form->field($model_adm, 'CARGO_ADM')->textInput(['maxlength' => true, 'placeholder' => 'Ej.: TÉCNICO DOCENTE', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'onkeypress' => 'return soloLetras(event);', 'onpaste' => 'return false']) ?>
                    <?= $form->field($model_adm, 'TITULO_ADM')->textInput(['maxlength' => true, 'placeholder' => 'Ej.: INGENIERO INFORMÁTICO', 'onkeyup' => 'javascript:this.value=this.value.toUpperCase();', 'onkeypress' => 'return soloLetras(event);', 'onpaste' => 'return false']) ?>
                    <?= $form->field($model, 'USUARIO_PER')->textInput(['maxlength' => true, 'placeholder' => 'Ej.: @Juan-2', 'onkeypress' => 'return validarUsuario(event);','title'=>'Caracteres permitidos: letras, números, especiales[ .@-_ ]']) ?>
                    <?php
