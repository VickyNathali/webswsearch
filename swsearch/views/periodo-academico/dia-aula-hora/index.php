...
/* @var $searchModel app\models\DiaAulaHoraSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Dia Aula Horas';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="dia-aula-hora-index">

    <h1><?= Html::encode($this->title) ?></h1>
    
    <p>
        <?= Html::a('Crear Dia Aula Hora', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
