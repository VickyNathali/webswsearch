...
/* @var $searchModel app\models\CarreraSemestreSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Carrera Semestres';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="carrera-semestre-index">

    <h1><?= Html::encode($this->title) ?></h1>
    
    <p>
        <?= Html::a('Crear Carrera Semestre', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
